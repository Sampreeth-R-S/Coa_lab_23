module testbench;
    ...
    reg [2:0] sel;
    wire [7:0] out;
    top_module M1(in1,in2,sel,out,clk);
    initial 
    begin
...
module  complementor (out, X, clock,enable);//Complementor for subtract
    input [7:0] X;
    input  clock;
    input enable;
    output [7:0] out;
    ...
    assign in2=1;
    wire carry_out;
    cla M1(in1,in2,carry_out,enable,clock,out);
...
module subtractor(in1,in2,enable,clock,diff_output);//Subtractor module
    ...
    wire [7:0] temp;
    wire carry_out;
    complementor C1 (temp,in2,clock,enable);//Temp stores 2's complement
